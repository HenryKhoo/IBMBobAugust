...
from app.schemas import QueryResponse, QueryResult
...
def run_query(question: str, top_k: int) -> QueryResponse:
    ...
    """
    hits = get_vector_store().similarity_search_with_relevance_scores(question, k=top_k)
